...
public class Anonimo extends Usuario {
    ...
    public Anonimo(int id, String usuario, String urlFoto, LatLng ubicacion, int edad, Boolean isOnline, String email, String password, String descripcion,ArrayList<String> imagenes, float rating) {
